...
public class DevelopersController {
    ...
    public String index(Model model) throws ParseException {
        FrontData frontData = new FrontData("mesg",developersService.sum1());
        model.addAttribute("frontData", developersService.sum1());
        return "index";
    }
}