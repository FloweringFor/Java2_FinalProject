            ...
            for (Object object : array){
                ...
                if (title != null) {
                    ...
                    for (int i = 0; i < titleArray.length; i++) {
                        titleArray[i] = titleArray[i].replaceAll("\\s*","").
                                replaceAll("[^(A-Za-z)]","").
                                replace(")","").replace("(","");
                    }
                }
                if (description != null) {
                    ...
                    for (int i = 0; i < descriptionArray.length; i++) {
                        descriptionArray[i] = descriptionArray[i].replaceAll("\\s*","").
                                replaceAll("[^(A-Za-z)]","").
                                replace(")","").replace("(","");
                    }
                }

                if (title!=null && title.length()>20 && title.length()<200) {
                    for (int i = 0; i < titleArray.length; i++) {
                        if (titleArray[i].length() >= 6 && titleArray[i].length() <= 11) {
                            for (int j = 0; j <= length; j++) {
                                if (j != length && keyWords[j].equals(titleArray[i])) {
                                    num[pt2]++;
                                    break;
                                }
                                if (j == length) {
                                    keyWords[j] = titleArray[i];
                                    pt2 = length;
                                    num[pt2]++;
                                    length++;
                                    break;
                ...
                if (description != null && description.length()>20 && description.length() < 400){
                    for (int i = 0; i < descriptionArray.length; i++) {
                        if (descriptionArray[i].length() >= 6 && descriptionArray[i].length() <= 11) {
                            for (int j = 0; j <= length; j++) {
                                if (j != length && keyWords[j].equals(descriptionArray[i])) {
                                    num[pt2]++;
                                    break;
                                }
                                if (j == length) {
                                    keyWords[j] = descriptionArray[i];
                                    pt2 = length;
                                    num[pt2]++;
                                    length++;
                                    break;
...
*/
    ...
    public void test() throws IOException, ParseException {
        ...
        for (int i = 0; i < repo_name.length; i++){
            ...
            // getTopicsData(repo_name[i]);
            // getCommentsData(repo_name[i]);
        }
